  ...
  <div className="pt-24 pb-20 bg-white">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <FadeIn>
          <div className="space-y-6">
            <span className="inline-flex items-center px-4 py-1 rounded-full bg-orange-50 text-orange-700 text-xs font-semibold tracking-[0.25em] uppercase">
              What is Dirisavi 5.0?
            </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-4">
              {[
                ...
                <div
                  key={i}
                  className="bg-orange-50 border border-orange-100 rounded-2xl px-4 py-3 text-sm shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300"
                >
        ...
        <FadeIn delay={100}>
          <div className="relative group">
            ...
            />
            <div className="absolute bottom-4 left-4 bg-white/90 backdrop-blur-md px-4 py-2 rounded-2xl shadow-lg text-xs font-semibold text-gray-700 flex items-center gap-2">
    ...
    <section className="bg-gray-50 py-20 mb-24">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Achievements */}
        <FadeIn delay={200}>
          <div className="mt-14 bg-white rounded-3xl shadow-xl px-6 sm:px-10 py-8 border border-emerald-100">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {[
            ...
            <FadeIn delay={i * 100} key={i}>
              <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl hover:-translate-y-2 transition-all duration-300 h-full border-t-4 border-orange-600">
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
      ...
      <div className="flex flex-wrap justify-center gap-4">
        {[
          ...
          <span
            key={i}
            className="px-6 py-3 rounded-full bg-white border border-gray-200 text-gray-700 shadow-sm text-lg hover:-translate-y-1 hover:shadow-md transition-all duration-200"
          >
            {tag}
          </span>
        ))}
