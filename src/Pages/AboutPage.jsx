...
">{item.value}</p>
        ...
        <FadeIn delay={100}>
          <div className="relative group">
            ...
            <img
              src="https://ik.imagekit.io/yiqhi8qnnw/Dirisavi/dirisavi5.0-banner.png"
 ...
 mt-4 mb-6">
    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-24">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <FadeIn>
          <img
            src="https://ik.imagekit.io/yiqhi8qnnw/Dirisavi/dirisavi-legacy.jpg?updatedAt=1765077591473"
 ...
 leading-relaxed">
          ...
          <FadeIn delay={100}>
            <div className="relative group">
              ...
              <img
                src="https://ik.imagekit.io/yiqhi8qnnw/Dirisavi/leo-fam.jpg?updatedAt=1765078434918"
    ...
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
      <FadeIn>
        ...
        <div className="relative group">
          ...
          <img
            src="https://ik.imagekit.io/yiqhi8qnnw/Dirisavi/dirisavi-oc-banner.png"
    ...
    <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 mt-10">
      <FadeIn>
        ...
        <div className="relative group">
          ...
          <img
            src="https://ik.imagekit.io/yiqhi8qnnw/Dirisavi/dirisavi-lb-banner.jpg"
