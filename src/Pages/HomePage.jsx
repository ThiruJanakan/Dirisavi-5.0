    ...
    <div className="bg-[#111] overflow-x-hidden font-sans selection:bg-orange-500 selection:text-white">
      ...
      <section ref={targetRef} className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
          <img
            src="/images/home-banner.jpg" // Ensure this path is valid
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          ...
          >
            ...
            <motion.h1 variants={staggerItem} className="text-5xl md:text-8xl font-bold text-white mb-6 leading-tight tracking-tight">
              Empowering Roots.
              <br />
            ...
            <motion.p variants={staggerItem} className="text-lg md:text-2xl text-gray-300 mb-10 max-w-3xl mx-auto font-light leading-relaxed">
              Igniting the potential of rural Sri Lanka through sustainable skill
              development and livelihood enhancement.
            </motion.p>

            <motion.div variants={staggerItem} className="flex flex-col sm:flex-row gap-5 justify-center items-center">
              <motion.button
